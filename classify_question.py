...
if __name__=='__main__':
    ...
    '''
    #This is just a predict function that will return the label for any sentence/question entered by keyboard. Uncomment
    #to use. Comment out the previous parts before using this.
